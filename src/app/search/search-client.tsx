...
import type { App, Mechanism, CaseStudy, Research, Campaign } from '@/lib/types'
...
export function SearchClient({ apps, mechanisms, caseStudies, research, campaigns }: SearchClientProps) {
