...
Direct Grants represent the traditional approach to funding allocation, where a committee, foundation, or individual reviews applications and directly awards funds to selected projects.
...
1. Call for proposals is announced
...
- [ESP Grants Process](https://esp.ethereum.foundation/applicants) - Ethereum Foundation example
