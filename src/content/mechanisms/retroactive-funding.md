...
Retroactive Public Goods Funding (RetroPGF) is a mechanism that rewards projects based on demonstrated impact rather than promised outcomes.
...
1. Projects build and ship public goods
...
- [Optimism RetroPGF Docs](https://community.optimism.io/docs/governance/retropgf-3/) - Official documentation
- [RetroPGF Experiment Design](https://vitalik.ca/general/2021/11/16/retro1.html) - Vitalik's original article
