...
slug: green-goods
name: "Green Goods"
shortDescription: "Green Goods is a local-first platform that helps communities document, verify, and finance regenerative work by connecting field activity to onchain attestations, treasury growth, and yield-backed capital formation."
banner: /content-images/apps/green-goods/banner.png
logo: /content-images/apps/green-goods/logo.png
tags:
  - "greenpill-dev-guild"
  - "greenpill"
  - "regenerative"
...
- **Category**: Platform  
- **Status**: Active  
- **Website**: https://greengoods.app  
- **Launch Date**: February 2026  
- **Blockchains**: Arbitrum, Celo  
- **Social Links**: [X](https://x.com/greengoodsapp) | [GitHub](https://github.com/greenpill-dev-guild/green-goods) | [Telegram](https://t.me/+N3o3_43iRec1Y2Jh)
...
- **Admin Dashboard:** [admin.greengoods.app](https://admin.greengoods.app)  
- **Documentation:** [docs.greengoods.app](https://docs.greengoods.app)  
- **How It Works:** [Green Goods Docs - How It Works](https://docs.greengoods.app/community/how-it-works)  
- **Builder / Technical Docs:** [Green Goods Docs - Builders](https://docs.greengoods.app/builders/getting-started)  
- **Article:** [Green Goods: Simplifying Impact Capture and Exchange](https://paragraph.com/@greenpilldevguild/green-goods-simplifying-impact-capture-and-exchange)  
- **Greenpill Dev Guild Blog:** [paragraph.com/@greenpilldevguild](https://paragraph.com/@greenpilldevguild)  
- **Greenpill Dev Guild GitHub:** [github.com/greenpill-dev-guild](https://github.com/greenpill-dev-guild)
