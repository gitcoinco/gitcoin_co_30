...
- [**Optimism Impact Case Study** — Gitcoin](https://impact.gitcoin.co/optimism)  
- [**On To New Beginnings** — Plasma Group](https://medium.com/plasma-group/on-to-new-beginnings-e9d76b170752)  
- [**Plasma Group researchers raise $3.5M from Paradigm and IDEO** — The Block](https://www.theblock.co/post/53017/plasma-group-researchers-raise-3-5m-from-paradigm-and-ideo-to-start-new-company)  
- [**A longitudinal assessment of Gitcoin Grants impact** — Open Source Observer](https://docs.opensource.observer/blog/gitcoin-grants-impact/)  
- [**Gitcoin Impact Results** — Gitcoin](https://impact.gitcoin.co/)
